...
from pyoci.framework import detect_framework, apply_framework_defaults
from pyoci.config import BuildConfig
from pyoci.sbom import generate_sbom, _get_python_packages
from pyoci.config_loader import load_config_file, merge_configs
...
def test_config_file_loading():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        config_path=Path(tmpdir)/"pyoci.toml"
