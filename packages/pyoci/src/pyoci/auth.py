...
class RegistryAuth:
    ...
    def from_user_pass_or_token(
        cls, password_or_token: Optional[str] = None, username: Optional[str] = None
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                return RegistryAuth.basic(
                    "00000000-0000-0000-0000-000000000000", data["accessToken"]
                )
        except:
            pass
...
def get_default_auth_provider() -> AuthProvider:
    ...
    return ChainAuthProvider(
        [EnvironmentAuthProvider(), DockerConfigAuthProvider(), AzureCLIAuthProvider()]
    )
...
def get_auth_for_registry(
    ...
    if username or password_or_token:
        return RegistryAuth.from_user_pass_or_token(
            username=username, password_or_token=password_or_token
        )
